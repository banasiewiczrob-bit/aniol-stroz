    ...
    <BackgroundWrapper>
      <ScrollView style={styles.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.headerCard}>
          <Image source={Watermark} resizeMode="contain" style={styles.headerWatermark} />
        ...
        {selectedProgram.steps.map((step, idx) => (
          <View key={`${selectedProgram.id}_${idx + 1}`} style={styles.stepCard}>
            <Image source={Watermark} resizeMode="contain" style={styles.stepWatermark} />
...
const styles = StyleSheet.create({
  ...
  subtitle: { ...TYPE.body, color: 'rgba(226,236,249,0.86)', marginBottom: 14 },
  chipsWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 12 },
  chip: {
    borderWidth: 1,
    borderColor: 'rgba(184,206,231,0.4)',
    borderRadius: 999,
    paddingVertical: 8,
    paddingHorizontal: 12,
    backgroundColor: 'rgba(24,46,74,0.64)',
  },
  chipActive: {
    borderColor: 'rgba(184,206,231,0.78)',
    backgroundColor: 'rgba(143,175,211,0.32)',
  },
  chipText: { ...TYPE.bodyStrong, color: 'rgba(255,255,255,0.85)' },
  chipTextActive: { color: 'white' },
  headerCard: {
    borderWidth: 1,
    borderColor: 'rgba(143,175,211,0.42)',
    borderRadius: 14,
    backgroundColor: 'rgba(20,44,73,0.72)',
    padding: 14,
    marginBottom: 12,
    overflow: 'hidden',
    position: 'relative',
  ...
  programNote: { ...TYPE.body, color: 'rgba(226,236,249,0.86)' },
  stepCard: {
    borderWidth: 1,
    borderColor: 'rgba(143,175,211,0.34)',
    borderRadius: 14,
    backgroundColor: 'rgba(20,44,73,0.66)',
    paddingVertical: 12,
    paddingHorizontal: 12,
    marginBottom: 8,
    flexDirection: 'row',
  ...
  badge: {
    ...
    backgroundColor: 'rgba(143,175,211,0.3)',
    borderWidth: 1,
    borderColor: 'rgba(184,206,231,0.62)',
  },
  badgeText: { ...TYPE.bodyStrong, color: 'white' },
  stepText: { ...TYPE.body, color: 'rgba(231,240,250,0.9)', flex: 1 },
});
