...
const allTiles: DashboardTile[] = [
  ...
  { title: 'Licznik', subtitle: 'Start i rocznice', to: '/licznik', accent: '#9EF3C7', glow: 'rgba(158,243,199,0.3)' },
  { title: 'Plan dnia', subtitle: 'Plan i HALT', to: '/plan-dnia', accent: '#FFD18A', glow: 'rgba(255,209,138,0.28)' },
  { title: 'Teksty codzienne', subtitle: 'Modlitwa, 24h, HALT, 12 kroków', to: '/teksty-codzienne', accent: '#C6B9FF', glow: 'rgba(198,185,255,0.28)' },
