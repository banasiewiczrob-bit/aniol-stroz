...
function buildSuggestion(topic: IntelligentSupportTopic, level: IntelligentSupportLevel, inAppOnly: boolean): IntelligentSupportSuggestion {
  ...
  if (level === 1) {
    if (topic === 'EMO') {
      return {
        ...
        level,
        title: 'Anioł Stróż',
        message: 'Ostatnie dni były bardziej napięte. Zatrzymaj się dziś na chwilę.',
    ...
    if (topic === 'WITHDRAW') {
      return {
        ...
        level,
        title: 'Anioł Stróż',
        message: 'Nie było Cię tu chwilę. Jeśli chcesz, wróć na jeden krok.',
    ...
    return {
      ...
      level,
      title: 'Anioł Stróż',
      message: 'W ostatnich dniach jest więcej napięcia. Zajrzyj dziś do siebie.',
  ...
  if (level === 2) {
    ...
    return {
      ...
      level,
      title: 'Anioł Stróż',
      message: 'Kilka dni z rzędu jest trudniej. Wybierz dziś jedną małą rzecz.',
  ...
  return {
    ...
    level,
    title: 'Anioł Stróż',
    message: 'Ostatni tydzień był wymagający. Sprawdź dziś swoją siatkę wsparcia.',
